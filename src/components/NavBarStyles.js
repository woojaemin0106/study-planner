...
export const navbarClasses = {
  ...
  header:
    "fixed top-0 left-0 w-full bg-white/90 backdrop-blur text-gray-900 z-50 shadow-md",
  ...
  logoLink:
    "text-3xl font-bold text-red-600 hover:text-red-500 tracking-wider transition",
  ...
  menuItemDays:
    "text-lg font-medium text-gray-800 hover:text-gray-500 transition-colors duration-200",
  menuItemTimer:
    "text-lg font-medium text-gray-800 hover:text-gray-500 transition-colors duration-200",
  menuItemChallenges:
    "text-lg font-medium text-gray-800 hover:text-gray-500 transition-colors duration-200",
  ...
  signupLink:
    "bg-gray-200 hover:bg-gray-300 text-gray-800 text-sm font-medium py-1.5 px-4 rounded transition duration-200",
