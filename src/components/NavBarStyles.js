...
export const navbarClasses = {
    ...
    menuItemDays: "text-lg font-medium text-gray-800 hover:text-gray-500 transition-colors duration-200",
    menuItemTimer: "text-lg font-medium text-gray-800 hover:text-gray-500 transition-colors duration-200",
    menuItemChallenges: "text-lg font-medium text-gray-800 hover:text-gray-500 transition-colors duration-200",
   ...
   signupLink: "bg-gray-200 hover:bg-gray-300 text-gray-800 text-sm font-medium py-1.5 px-4 rounded transition duration-200",
