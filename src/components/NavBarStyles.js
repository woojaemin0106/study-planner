export const navbarClasses = {
  ...
  header:
    "fixed top-0 left-0 w-full text-black-400 z-50 transition duration-300 ease-in shadow-md",
  ...
  signupLink:
    "bg-red-600 hover:bg-red-700 text-white text-sm font-medium py-1.5 px-4 rounded transition duration-200",
